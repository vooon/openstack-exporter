...
`openstack_ironic_node` | `ironic-node` | `id,name,provision_state,power_state,maintenance,maintenance_reason,console_enabled,resource_class,retired,retired_reason` | labels can be extended with `--ironic.node-extra-labels`
